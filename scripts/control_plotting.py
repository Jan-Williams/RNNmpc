...
if cont_results_1['sim'] == 'LorenzControl':
    ...
    ax[1].plot(t_range, cont_results_2['S_controlled'][1] ,'--', linewidth=2, label='LSTM')
    # ax[1].plot(t_range, lstm_results['S_controlled'][1] ,'--', linewidth=2, label='LSTM')
    ax[2].plot(t_range, cont_results_1['ref_traj'][2][:1600], linewidth=2, c='k')
    ax[2].plot(t_range, cont_results_1['S_controlled'][2] ,'--', linewidth=2, label='ESN')
    ax[2].plot(t_range, cont_results_2['S_controlled'][2] ,'--', linewidth=2, label='LSTM')
    # ax[1].plot(t_range, lstm_results['S_controlled'][1] ,'--', linewidth=2, label='LSTM')
    ...
    ax[3].plot(t_range, cont_results_1['U'][0], '--', linewidth=2, label='ESN')
    ax[3].plot(t_range, cont_results_2['U'][0], '--', linewidth=2, label='LSTM')
    # ax[2].plot(t_range, cont_results['U'][1], '--', linewidth=2, label='ESN')
    # ax[3].plot(t_range, lstm_results['U'][0], '--', linewidth=2, label='LSTM')
